...
public class UserPermissionRemoveCommand extends BSStandAloneCommand {

    public UserPermissionRemoveCommand() {
        super("remove", "Remove a user's permissions",
                ...
                new OptionData(OptionType.STRING, "platform-id", "ID: Minecraft (uuid/name) or Discord (id/tag)")
                        .setRequired(true),
                new OptionData(OptionType.STRING, "permissions", "Permissions removed, connected by ; (eg. \"durations;bansystem\")")
                        .setRequired(true));
    }
